...
use crate::platform::platform::DevivePassthroughFilter;
...
impl Kernel {
    ...
    pub fn allocate_device_passthrough<KR: KernelResources<C>, C: Chip>(
        &self,
        resources: &KR,
        processid: &ProcessId,
        address: usize,
        ...
        let filter = resources.passthrough_filter();
