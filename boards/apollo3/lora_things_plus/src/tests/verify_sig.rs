...
impl<'a> HmacTestCallback {
    fn new(message_buffer: &'static mut [u8; 32], signature_buffer: &'static mut [u8; 64], pub_key_buffer: &'static mut [u8; 64]) -> Self {
        HmacTestCallback {
...
macro_rules! static_init_test_cb {
    () => {{
        ...
        let signature_data = static_init!(
            [u8; 64],
            [
                0xd7, 0x09, 0xd8, 0x2a, 0xdc, 0x15, 0x3c, 0xc4, 0x2e, 0x37, 0xd3, 0x91, 0x92, 0xe2, 0x0d, 0x6a, 0xa9, 0x68, 0xf7, 0x10, 0xbb, 0x38, 0xc2, 0x16, 0xf3, 0x4f, 0x59, 0xdc, 0x69, 0x72, 0x59, 0xc2, 0xe3, 0x9c, 0x27, 0x7f, 0x32, 0x63, 0xc8, 0xbf, 0x27, 0x26, 0x5b, 0x8a, 0x11, 0x68, 0x90, 0x02, 0xa6, 0x7b, 0x3e, 0x72, 0x59, 0x9e, 0x6c, 0x85, 0xda, 0x00, 0xc8, 0xca, 0x87, 0x37, 0x7d, 0x1a
            ]
        );
